class ScholarshipStudent extends Student {
    ...
    // Constructor
    public ScholarshipStudent(String name, int age, String gender, double weight, String nationality, int year, char section, double cgpa, int[] noOfGrades,int paidfees) {
        super(name, age, gender, weight, nationality, year, section, cgpa, noOfGrades,paidfees);
